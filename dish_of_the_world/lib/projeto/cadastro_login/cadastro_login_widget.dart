...
class _CadastroLoginWidgetState extends State<CadastroLoginWidget>
  ...
  void initState() {
    ...
    _model.emailAddressCreateTextController6 ??= TextEditingController();
    _model.emailAddressCreateFocusNode6 ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFF206389),
        body: SafeArea(
          top: true,
          child: Stack(
            children: [
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 24.0),
                                                    child: Text(
                                                      'Preencha as informações abaixo para criar a sua conta Dish of the World.',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style:
                                                          FlutterFlowTheme.of(
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        autofocus: true,
                                                        obscureText: false,
                                                        inputFormatters: [_model.cpfFormatter],
                                                        decoration:
                                                            InputDecoration(
                                                          labelText: 'CPF',
                                                          labelStyle:
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextFormField(
                                                        ...
                                                        autofocus: true,
                                                        obscureText: false,
                                                        inputFormatters: [_model.telefoneFormatter],
                                                        decoration:
                                                            InputDecoration(
                                                          labelText: 'Telefone',
                                                          labelStyle:
                                                    ...
                                                    padding:
                                                        EdgeInsetsDirectional
                                                            .fromSTEB(0.0, 4.0,
                                                                0.0, 24.0),
                                                    child: Text(
                                                      'Preencha as informações abaixo para acessar a sua conta Dish of the World.',
                                                      textAlign:
                                                          TextAlign.start,
                                                      style:
                                                          FlutterFlowTheme.of(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          try {
                                                            // Tentar fazer login
                                                            final resultado = await _model.loginUsuario();
                                                            
                                                            if (resultado['success'] == true) {
                                                              // Salvar dados do usuário
                                                              final userData = resultado['data'];
